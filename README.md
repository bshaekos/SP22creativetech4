...
I'm very satisfied with the results of the project but I was hoping to accomplish more by having the VFX effects modified by the music. I found myself completely enraptured throughout the entire project, and Unity is a software that I want to be very well-versed in. I was surprised by how well I was able to create the desired effect without tutorials. Learning by tutorials might not be the best route for me given the level of complexity I seek in a mixed reality project. After the project, I did find a conference talk by Keijiro that I plan to watch in depth to learn more about the fundamental aspects of the VFX Graph tool in Unity. 
